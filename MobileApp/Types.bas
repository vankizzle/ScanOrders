...
Sub Process_Globals
	...
	Type Order(ID As Int,OrderCode As String,OrderTotalPrice As Double,Goods As List,CutomerID As Int,OrderStatus As String)
	...
	Type Good (ID As Int , Qtty As Int , DetailID As Int, SupplierID As Int,PLU As Int,Name As String,Price As Double,Description As String,Is_Discontinued As Int)
