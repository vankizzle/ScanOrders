...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"HttpUtils2Service",_ref.getField(false, "_httputils2service"),"loginbtn",_ref.getField(false, "_loginbtn"),"Logo",_ref.getField(false, "_logo"),"passwordtxt",_ref.getField(false, "_passwordtxt"),"registerbtn",_ref.getField(false, "_registerbtn"),"ScreenLogo",_ref.getField(false, "_screenlogo"),"ScreenPnl",_ref.getField(false, "_screenpnl"),"settingsbtn",_ref.getField(false, "_settingsbtn"),"SettingsButton",_ref.getField(false, "_settingsbutton"),"SettingsMenuLogin",_ref.getField(false, "_settingsmenulogin"),"usernametxt",_ref.getField(false, "_usernametxt")};
}
}