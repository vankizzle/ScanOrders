...
try {
		Debug.PushSubsStack("Initialize (uisizes) ","uisizes",5,_ba,uisizes.mostCurrent,18);
...
uisizes._edittextdefaultheight = uisizes.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),_ba);
 BA.debugLineNum = 28;BA.debugLine="ScanBtnDefaultLeft = 20%x";
Debug.ShouldStop(134217728);
uisizes._scanbtndefaultleft = uisizes.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 20)),_ba);
 BA.debugLineNum = 29;BA.debugLine="ScanBtnDefaultTop  = 88%y";
Debug.ShouldStop(268435456);
uisizes._scanbtndefaulttop = uisizes.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 88)),_ba);
 BA.debugLineNum = 30;BA.debugLine="ScanBtnDefaultWidth = 60%x";
Debug.ShouldStop(536870912);
uisizes._scanbtndefaultwidth = uisizes.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 60)),_ba);
 BA.debugLineNum = 31;BA.debugLine="ScanBtnDefaultHeight = 10%y";
Debug.ShouldStop(1073741824);
uisizes._scanbtndefaultheight = uisizes.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 10)),_ba);
 };
