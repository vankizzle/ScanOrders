...
try {
		Debug.PushSubsStack("Application_Error (starter) ","starter",11,starter.processBA,starter.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Service_Destroy (starter) ","starter",11,starter.processBA,starter.mostCurrent,32);
...
try {
		Debug.PushSubsStack("Service_TaskRemoved (starter) ","starter",11,starter.processBA,starter.mostCurrent,23);
