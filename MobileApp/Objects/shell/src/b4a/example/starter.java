...
public static b4a.example.support _support = null;
  public Object[] GetGlobals() {
		return new Object[] {"HttpUtils2Service",starter.mostCurrent._httputils2service,"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"Support",Debug.moduleToString(b4a.example.support.class),"Types",Debug.moduleToString(b4a.example.types.class),"UISizes",Debug.moduleToString(b4a.example.uisizes.class)};
}
}