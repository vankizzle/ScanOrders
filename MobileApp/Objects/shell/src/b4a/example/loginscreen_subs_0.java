...
try {
		Debug.PushSubsStack("AsView (loginscreen) ","loginscreen",2,__ref.getField(false, "ba"),__ref,89);
...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 90;BA.debugLine="Return ScreenPnl";
...
__ref.getField(false,"_usernametxt").runMethod(true,"setHint",BA.ObjectToString("Username"));
 BA.debugLineNum = 53;BA.debugLine="usernametxt.HintColor = Colors.LightGray";
...
__ref.getField(false,"_passwordtxt").runVoidMethod ("setSingleLine",loginscreen.__c.getField(true,"True"));
 BA.debugLineNum = 57;BA.debugLine="passwordtxt.HintColor = Colors.LightGray";
Debug.ShouldStop(16777216);
...
_bc.runVoidMethod ("Initialize",(Object)(loginscreen.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("optbutton.png")));
 BA.debugLineNum = 82;BA.debugLine="SettingsButton.Color = Colors.DarkGray";
...
try {
		Debug.PushSubsStack("Login_Click (loginscreen) ","loginscreen",2,__ref.getField(false, "ba"),__ref,113);
if (RapidSub.canDelegate("login_click")) { return __ref.runUserSub(false, "loginscreen","login_click", __ref);}
 BA.debugLineNum = 113;BA.debugLine="Public Sub Login_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 114;BA.debugLine="If usernametxt.TextSize > 0 Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean(">",__ref.getField(false,"_usernametxt").runMethod(true,"getTextSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 115;BA.debugLine="If passwordtxt.TextSize > 0 Then";
Debug.ShouldStop(262144);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 142;BA.debugLine="CallSub(Main,\"ShowRegisterScreen\")";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("Settings_Click (loginscreen) ","loginscreen",2,__ref.getField(false, "ba"),__ref,97);
if (RapidSub.canDelegate("settings_click")) { return __ref.runUserSub(false, "loginscreen","settings_click", __ref);}
 BA.debugLineNum = 97;BA.debugLine="Public Sub Settings_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 106;BA.debugLine="If SettingsMenuLogin.AsView.Left = -15%x Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.example.settingsmenu.class, "_asview").runMethod(true,"getLeft"),BA.numberCast(double.class, -(double) (0 + loginscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba")).<Integer>get().intValue())))) { 
 BA.debugLineNum = 107;BA.debugLine="SettingsMenuLogin.AsView.SetLayoutAnimated(500,0";
Debug.ShouldStop(1024);
__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.example.settingsmenu.class, "_asview").runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 500)),(Object)(BA.numberCast(int.class, 0)),(Object)(loginscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))),(Object)(loginscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba"))),(Object)(loginscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }else 
{ BA.debugLineNum = 108;BA.debugLine="else if SettingsMenuLogin.AsView.Left = 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.example.settingsmenu.class, "_asview").runMethod(true,"getLeft"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 109;BA.debugLine="SettingsMenuLogin.AsView.SetLayoutAnimated(500,-";
Debug.ShouldStop(4096);
__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.example.settingsmenu.class, "_asview").runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 500)),(Object)(BA.numberCast(int.class, -(double) (0 + loginscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba")).<Integer>get().intValue()))),(Object)(loginscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))),(Object)(loginscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba"))),(Object)(loginscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }}
;
...
try {
		Debug.PushSubsStack("SettingsIsVisible (loginscreen) ","loginscreen",2,__ref.getField(false, "ba"),__ref,93);
if (RapidSub.canDelegate("settingsisvisible")) { return __ref.runUserSub(false, "loginscreen","settingsisvisible", __ref);}
 BA.debugLineNum = 93;BA.debugLine="Public Sub SettingsIsVisible As Boolean";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 94;BA.debugLine="Return SettingsMenuLogin.AsView.Visible";
Debug.ShouldStop(536870912);
