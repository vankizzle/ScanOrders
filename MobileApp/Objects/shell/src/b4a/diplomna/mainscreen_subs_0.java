...
mainscreen.__c.runVoidMethod ("LogImpl","53866625",RemoteObject.concat(RemoteObject.createImmutable("Camera Exists- "),_success),0);
...
Debug.ShouldStop(8388608);
mainscreen.__c.runVoidMethod ("LogImpl","53932161",RemoteObject.createImmutable("Start- Checking Camera"),0);
...
Debug.ShouldStop(1);
mainscreen.__c.runVoidMethod ("LogImpl","53997699",RemoteObject.createImmutable("End- Checking Camera"),0);
...
Debug.ShouldStop(32);
mainscreen.__c.runVoidMethod ("LogImpl","54063234",RemoteObject.createImmutable("click"),0);
...
Debug.ShouldStop(256);
mainscreen.__c.runVoidMethod ("LogImpl","54063237",RemoteObject.concat(RemoteObject.createImmutable("Camera:"),__ref.getField(true,"_cameraexists")),0);
 };
