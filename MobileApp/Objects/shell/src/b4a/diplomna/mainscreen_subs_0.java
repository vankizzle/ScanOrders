...
try {
		Debug.PushSubsStack("AsView (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,72);
if (RapidSub.canDelegate("asview")) { return __ref.runUserSub(false, "mainscreen","asview", __ref);}
 BA.debugLineNum = 72;BA.debugLine="Public Sub AsView As View";
Debug.ShouldStop(128);
 BA.debugLineNum = 73;BA.debugLine="Return ScreenPnl";
...
try {
		Debug.PushSubsStack("BuildUI (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,51);
...
RemoteObject _bc = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
 BA.debugLineNum = 51;BA.debugLine="Public Sub BuildUI";
Debug.ShouldStop(262144);
 BA.debugLineNum = 53;BA.debugLine="ScreenPnl.Color = Colors.White";
Debug.ShouldStop(1048576);
__ref.getField(false,"_screenpnl").runVoidMethod ("setColor",mainscreen.__c.getField(false,"Colors").getField(true,"White"));
 BA.debugLineNum = 54;BA.debugLine="ScreenPnl.AddView(Header,0,0,100%x,5%y)";
...
__ref.getField(false,"_screenpnl").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_header").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 BA.debugLineNum = 55;BA.debugLine="Header.Color = Colors.RGB(182,0,0)";
Debug.ShouldStop(4194304);
__ref.getField(false,"_header").runVoidMethod ("setColor",mainscreen.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 182)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0))));
 BA.debugLineNum = 58;BA.debugLine="Dim bc As Bitmap";
...
_bc = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 59;BA.debugLine="bc.Initialize(File.DirAssets,\"optbutton.png\")";
...
_bc.runVoidMethod ("Initialize",(Object)(mainscreen.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("optbutton.png")));
 BA.debugLineNum = 60;BA.debugLine="SettingsButton.SetBackgroundImage(bc)";
Debug.ShouldStop(134217728);
__ref.getField(false,"_settingsbutton").runVoidMethod ("SetBackgroundImageNew",(Object)((_bc.getObject())));
 BA.debugLineNum = 61;BA.debugLine="Header.AddView(SettingsButton,0,0 + 2dip,10%x,5%y";
...
__ref.getField(false,"_header").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_settingsbutton").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(0),mainscreen.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "+",1, 1)),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 10)),__ref.getField(false, "ba"))),(Object)(RemoteObject.solve(new RemoteObject[] {mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba")),mainscreen.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 4)))}, "-",1, 1)));
 BA.debugLineNum = 63;BA.debugLine="ScreenPnl.AddView(downPanel, UISizes.ScanBtnDefau";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_screenpnl").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_downpanel").getObject())),(Object)(mainscreen._uisizes._scanbtndefaultleft),(Object)(mainscreen._uisizes._scanbtndefaulttop),(Object)(mainscreen._uisizes._scanbtndefaultwidth),(Object)(mainscreen._uisizes._scanbtndefaultheight));
 BA.debugLineNum = 64;BA.debugLine="downPanel.Bitmap = LoadBitmap(File.DirAssets,\"Sca";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_downpanel").runMethod(false,"setBitmap",(mainscreen.__c.runMethod(false,"LoadBitmap",(Object)(mainscreen.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("ScanBtn.png"))).getObject()));
 BA.debugLineNum = 65;BA.debugLine="downPanel.Gravity = Gravity.FILL";
Debug.ShouldStop(1);
__ref.getField(false,"_downpanel").runMethod(true,"setGravity",mainscreen.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 67;BA.debugLine="ScreenPnl.AddView(Cart.AsView,5%x,35%y,90%x,50%y)";
Debug.ShouldStop(4);
__ref.getField(false,"_screenpnl").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_cart").runClassMethod (b4a.diplomna.shoppingcart.class, "_asview").getObject())),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 35)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 90)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 50)),__ref.getField(false, "ba"))));
 BA.debugLineNum = 68;BA.debugLine="ScreenPnl.AddView(InfoScreen.AsView,5%x,10%y,90%x";
Debug.ShouldStop(8);
__ref.getField(false,"_screenpnl").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_infoscreen").runClassMethod (b4a.diplomna.iteminfovisualizer.class, "_asview").getObject())),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 10)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 90)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 24)),__ref.getField(false, "ba"))));
 BA.debugLineNum = 69;BA.debugLine="ScreenPnl.AddView(SettingsMenuLogin.AsView,-15%x,";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("CameraCheck_Ready (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,76);
...
Debug.locals.put("Success", _success);
 BA.debugLineNum = 76;BA.debugLine="Private Sub CameraCheck_Ready (Success As Boolean)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 77;BA.debugLine="Log(\"Camera Exists- \"&Success)";
Debug.ShouldStop(4096);
mainscreen.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Camera Exists- "),_success)));
 BA.debugLineNum = 78;BA.debugLine="CameraExists=Success";
Debug.ShouldStop(8192);
__ref.setField ("_cameraexists",_success);
 BA.debugLineNum = 79;BA.debugLine="CallSubDelayed(Me,\"Remove_CameraChecker\")";
...
try {
		Debug.PushSubsStack("Check_IfCameraExists (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,83);
if (RapidSub.canDelegate("check_ifcameraexists")) { return __ref.runUserSub(false, "mainscreen","check_ifcameraexists", __ref);}
 BA.debugLineNum = 83;BA.debugLine="Public Sub Check_IfCameraExists";
Debug.ShouldStop(262144);
 BA.debugLineNum = 84;BA.debugLine="Log(\"Start- Checking Camera\")";
Debug.ShouldStop(524288);
mainscreen.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("Start- Checking Camera")));
 BA.debugLineNum = 85;BA.debugLine="pnlCheckCamera.Initialize(\"\")";
Debug.ShouldStop(1048576);
__ref.getField(false,"_pnlcheckcamera").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 86;BA.debugLine="ScreenPnl.AddView(pnlCheckCamera,-999,-999,1dip,1";
Debug.ShouldStop(2097152);
__ref.getField(false,"_screenpnl").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_pnlcheckcamera").getObject())),(Object)(BA.numberCast(int.class, -(double) (0 + 999))),(Object)(BA.numberCast(int.class, -(double) (0 + 999))),(Object)(mainscreen.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))),(Object)(mainscreen.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))));
 BA.debugLineNum = 87;BA.debugLine="camera.Initialize(pnlCheckCamera,\"CameraCheck\")";
Debug.ShouldStop(4194304);
...
mainscreen._screenpnl = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_screenpnl",mainscreen._screenpnl);
 //BA.debugLineNum = 3;BA.debugLine="Public downPanel As ImageView";
mainscreen._downpanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_downpanel",mainscreen._downpanel);
...
try {
		Debug.PushSubsStack("HideSettings (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,37);
if (RapidSub.canDelegate("hidesettings")) { return __ref.runUserSub(false, "mainscreen","hidesettings", __ref);}
 BA.debugLineNum = 37;BA.debugLine="Public Sub HideSettings";
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="If SettingsMenuLogin.AsView.Left = 0 Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.diplomna.settingsmenu.class, "_asview").runMethod(true,"getLeft"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 39;BA.debugLine="SettingsMenuLogin.AsView.SetLayoutAnimated(500,-";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("Initialize (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,18);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 19;BA.debugLine="ScreenPnl.Initialize(\"\")";
Debug.ShouldStop(262144);
__ref.getField(false,"_screenpnl").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 21;BA.debugLine="downPanel.Initialize(\"startScan\")";
Debug.ShouldStop(1048576);
__ref.getField(false,"_downpanel").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("startScan")));
 BA.debugLineNum = 22;BA.debugLine="Header.Initialize(\"\")";
Debug.ShouldStop(2097152);
__ref.getField(false,"_header").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 23;BA.debugLine="SettingsButton.Initialize(\"Settings\")";
Debug.ShouldStop(4194304);
__ref.getField(false,"_settingsbutton").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("Settings")));
 BA.debugLineNum = 24;BA.debugLine="SettingsMenuLogin.Initialize(1)";
Debug.ShouldStop(8388608);
...
__ref.getField(false,"_infoscreen").runClassMethod (b4a.diplomna.iteminfovisualizer.class, "_initialize",__ref.getField(false, "ba"));
 BA.debugLineNum = 29;BA.debugLine="BuildUI";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4a.diplomna.mainscreen.class, "_buildui");
 BA.debugLineNum = 30;BA.debugLine="Check_IfCameraExists";
...
try {
		Debug.PushSubsStack("QRScanner_result (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,107);
...
Debug.locals.put("Values", _values);
 BA.debugLineNum = 107;BA.debugLine="Public Sub QRScanner_result(atype As String, Value";
...
try {
		Debug.PushSubsStack("Remove_CameraChecker (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,90);
if (RapidSub.canDelegate("remove_camerachecker")) { return __ref.runUserSub(false, "mainscreen","remove_camerachecker", __ref);}
 BA.debugLineNum = 90;BA.debugLine="private Sub Remove_CameraChecker";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 91;BA.debugLine="camera.Release";
Debug.ShouldStop(67108864);
__ref.getField(false,"_camera").runVoidMethod ("Release");
 BA.debugLineNum = 92;BA.debugLine="pnlCheckCamera.RemoveView";
Debug.ShouldStop(134217728);
__ref.getField(false,"_pnlcheckcamera").runVoidMethod ("RemoveView");
 BA.debugLineNum = 93;BA.debugLine="Log(\"End- Checking Camera\")";
Debug.ShouldStop(268435456);
mainscreen.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("End- Checking Camera")));
...
try {
		Debug.PushSubsStack("Settings_Click (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,43);
if (RapidSub.canDelegate("settings_click")) { return __ref.runUserSub(false, "mainscreen","settings_click", __ref);}
 BA.debugLineNum = 43;BA.debugLine="Public Sub Settings_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="If SettingsMenuLogin.AsView.Left = -15%x Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.diplomna.settingsmenu.class, "_asview").runMethod(true,"getLeft"),BA.numberCast(double.class, -(double) (0 + mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba")).<Integer>get().intValue())))) { 
 BA.debugLineNum = 45;BA.debugLine="SettingsMenuLogin.AsView.SetLayoutAnimated(500,0";
Debug.ShouldStop(4096);
...
{ BA.debugLineNum = 46;BA.debugLine="else if SettingsMenuLogin.AsView.Left = 0 Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.diplomna.settingsmenu.class, "_asview").runMethod(true,"getLeft"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 47;BA.debugLine="SettingsMenuLogin.AsView.SetLayoutAnimated(500,-";
Debug.ShouldStop(16384);
__ref.getField(false,"_settingsmenulogin").runClassMethod (b4a.diplomna.settingsmenu.class, "_asview").runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 500)),(Object)(BA.numberCast(int.class, -(double) (0 + mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba")).<Integer>get().intValue()))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 15)),__ref.getField(false, "ba"))),(Object)(mainscreen.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 10)),__ref.getField(false, "ba"))));
 }}
;
...
try {
		Debug.PushSubsStack("SettingsIsVisible (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,33);
if (RapidSub.canDelegate("settingsisvisible")) { return __ref.runUserSub(false, "mainscreen","settingsisvisible", __ref);}
 BA.debugLineNum = 33;BA.debugLine="Public Sub SettingsIsVisible As Int";
Debug.ShouldStop(1);
 BA.debugLineNum = 34;BA.debugLine="Return SettingsMenuLogin.AsView.Left";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("startScan_Click (mainscreen) ","mainscreen",3,__ref.getField(false, "ba"),__ref,96);
if (RapidSub.canDelegate("startscan_click")) { return __ref.runUserSub(false, "mainscreen","startscan_click", __ref);}
 BA.debugLineNum = 96;BA.debugLine="Public Sub startScan_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 97;BA.debugLine="If CameraExists Then";
Debug.ShouldStop(1);
if (__ref.getField(true,"_cameraexists").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 98;BA.debugLine="Log(\"click\")";
Debug.ShouldStop(2);
mainscreen.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("click")));
 BA.debugLineNum = 100;BA.debugLine="Cart.TestWithFakes(10)";
Debug.ShouldStop(8);
__ref.getField(false,"_cart").runClassMethod (b4a.diplomna.shoppingcart.class, "_testwithfakes",(Object)(BA.numberCast(int.class, 10)));
 BA.debugLineNum = 101;BA.debugLine="Cart.BuildCart";
Debug.ShouldStop(16);
__ref.getField(false,"_cart").runClassMethod (b4a.diplomna.shoppingcart.class, "_buildcart");
 }else {
 BA.debugLineNum = 103;BA.debugLine="Log(\"Camera:\"&CameraExists)";
Debug.ShouldStop(64);
mainscreen.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Camera:"),__ref.getField(true,"_cameraexists"))));
 };
