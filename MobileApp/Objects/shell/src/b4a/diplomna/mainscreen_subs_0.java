...
try {
		Debug.PushSubsStack("AsView (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("BuildUI (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("CameraCheck_Ready (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,80);
...
mainscreen.__c.runVoidMethod ("LogImpl","12949121",RemoteObject.concat(RemoteObject.createImmutable("Camera Exists- "),_success),0);
...
try {
		Debug.PushSubsStack("Check_IfCameraExists (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,87);
...
Debug.ShouldStop(8388608);
mainscreen.__c.runVoidMethod ("LogImpl","13014657",RemoteObject.createImmutable("Start- Checking Camera"),0);
...
try {
		Debug.PushSubsStack("HideSettings (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("Initialize (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("QRScanner_result (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("Remove_CameraChecker (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,94);
...
Debug.ShouldStop(1);
mainscreen.__c.runVoidMethod ("LogImpl","13080195",RemoteObject.createImmutable("End- Checking Camera"),0);
...
try {
		Debug.PushSubsStack("Settings_Click (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("SettingsIsVisible (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("startScan_Click (mainscreen) ","mainscreen",6,__ref.getField(false, "ba"),__ref,100);
...
Debug.ShouldStop(32);
mainscreen.__c.runVoidMethod ("LogImpl","13145730",RemoteObject.createImmutable("click"),0);
...
Debug.ShouldStop(256);
mainscreen.__c.runVoidMethod ("LogImpl","13145733",RemoteObject.concat(RemoteObject.createImmutable("Camera:"),__ref.getField(true,"_cameraexists")),0);
 };
