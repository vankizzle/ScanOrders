...
try {
		Debug.PushSubsStack("ApplyViewStyle (support) ","support",12,_ba,support.mostCurrent,10);
...
try {
		Debug.PushSubsStack("Gradient (support) ","support",12,_ba,support.mostCurrent,33);
...
try {
		Debug.PushSubsStack("MinimumPadding (support) ","support",12,_ba,support.mostCurrent,83);
