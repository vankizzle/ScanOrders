...
jsonserializations.mostCurrent.__c.runVoidMethod ("LogImpl","314680071",_jsongenerator.runMethod(true,"ToPrettyString",(Object)(BA.numberCast(int.class, 0))),0);
...
_jsondata.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("orderStatus"))),(Object)((_o.getField(true,"OrderStatus"))));
 BA.debugLineNum = 104;BA.debugLine="For Each og As OrderedGoods In o.OrderedGoods";
Debug.ShouldStop(128);
{
