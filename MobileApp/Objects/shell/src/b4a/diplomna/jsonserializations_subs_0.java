...
try {
		Debug.PushSubsStack("CustomerID (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,82);
...
jsonserializations.mostCurrent.__c.runVoidMethod ("LogImpl","55242887",_jsongenerator.runMethod(true,"ToPrettyString",(Object)(BA.numberCast(int.class, 0))),0);
...
try {
		Debug.PushSubsStack("CustomerToJSON (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,121);
...
jsonserializations.mostCurrent.__c.runVoidMethod ("LogImpl","55373968",_jsongenerator.runMethod(true,"ToPrettyString",(Object)(BA.numberCast(int.class, 0))),0);
...
try {
		Debug.PushSubsStack("LoginJson (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,70);
...
jsonserializations.mostCurrent.__c.runVoidMethod ("LogImpl","55177352",_jsongenerator.runMethod(true,"ToPrettyString",(Object)(BA.numberCast(int.class, 0))),0);
...
try {
		Debug.PushSubsStack("OrderToJSON (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,93);
...
Debug.ShouldStop(1048576);
jsonserializations.mostCurrent.__c.runVoidMethod ("LogImpl","55308440",_jsongenerator.runMethod(true,"ToPrettyString",(Object)(BA.numberCast(int.class, 0))),0);
...
try {
		Debug.PushSubsStack("SerializeCustomerOrders (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,142);
...
try {
		Debug.PushSubsStack("SerializeGood (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,10);
...
try {
		Debug.PushSubsStack("SerializeLoginCustomer (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,48);
...
try {
		Debug.PushSubsStack("SerializeOrderedGoods (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,172);
...
try {
		Debug.PushSubsStack("SerializeSupplier (jsonserializations) ","jsonserializations",8,_ba,jsonserializations.mostCurrent,31);
