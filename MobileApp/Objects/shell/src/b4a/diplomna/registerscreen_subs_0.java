...
try {
		Debug.PushSubsStack("CheckForMissingFields (registerscreen) ","registerscreen",11,__ref.getField(false, "ba"),__ref,238);
...
try {
		Debug.PushSubsStack("ClearTextFields (registerscreen) ","registerscreen",11,__ref.getField(false, "ba"),__ref,266);
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","49437213",RemoteObject.createImmutable("LOGIN FAILED"),0);
 if (true) break;
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","49437221",RemoteObject.createImmutable("missing info"),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("ReturnToLoginScreen (registerscreen) ","registerscreen",11,__ref.getField(false, "ba"),__ref,262);
...
try {
		Debug.PushSubsStack("SendInfoToAPI (registerscreen) ","registerscreen",11,__ref.getField(false, "ba"),__ref,278);
