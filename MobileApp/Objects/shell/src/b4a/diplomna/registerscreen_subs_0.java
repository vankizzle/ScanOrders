...
try {
		Debug.PushSubsStack("AsView (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("BackInfo_Click (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,165);
...
try {
		Debug.PushSubsStack("BackInfo1_Click (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,173);
...
try {
		Debug.PushSubsStack("BuildInfo1 (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("BuildInfo2 (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("BuildUI (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("CheckForMissingFields (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,221);
...
try {
		Debug.PushSubsStack("ClearTextFields (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,249);
...
try {
		Debug.PushSubsStack("Initialize (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("NextInfo_Click (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("NextInfo1_Click (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,169);
...
try {
		Debug.PushSubsStack("RegistrationDone_Click (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,197);
...
Debug.ShouldStop(524288);
registerscreen.__c.runVoidMethod ("LogImpl","47995407",RemoteObject.createImmutable("successfully registered"),0);
 BA.debugLineNum = 213;BA.debugLine="Log(NewCustomer)";
Debug.ShouldStop(1048576);
registerscreen.__c.runVoidMethod ("LogImpl","47995408",BA.ObjectToString(_newcustomer),0);
...
Debug.ShouldStop(16777216);
registerscreen.__c.runVoidMethod ("LogImpl","47995412",RemoteObject.createImmutable("missing info"),0);
 };
...
try {
		Debug.PushSubsStack("ReturnToLoginScreen (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,245);
...
try {
		Debug.PushSubsStack("SendInfoToAPI (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,261);
...
try {
		Debug.PushSubsStack("ShowInfo1 (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,177);
...
try {
		Debug.PushSubsStack("ShowInfo2 (registerscreen) ","registerscreen",13,__ref.getField(false, "ba"),__ref,187);
