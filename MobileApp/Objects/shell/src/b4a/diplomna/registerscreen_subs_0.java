...
Debug.ShouldStop(524288);
registerscreen.__c.runVoidMethod ("LogImpl","57995407",RemoteObject.createImmutable("successfully registered"),0);
 BA.debugLineNum = 213;BA.debugLine="Log(NewCustomer)";
Debug.ShouldStop(1048576);
registerscreen.__c.runVoidMethod ("LogImpl","57995408",BA.ObjectToString(_newcustomer),0);
...
Debug.ShouldStop(16777216);
registerscreen.__c.runVoidMethod ("LogImpl","57995412",RemoteObject.createImmutable("missing info"),0);
 };
