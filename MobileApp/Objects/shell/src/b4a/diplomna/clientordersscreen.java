...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CartOrders",_ref.getField(false, "_cartorders"),"FakePnl",_ref.getField(false, "_fakepnl"),"Header",_ref.getField(false, "_header"),"OrderInfoVisual",_ref.getField(false, "_orderinfovisual"),"ScreenPnl",_ref.getField(false, "_screenpnl"),"SettingsButton",_ref.getField(false, "_settingsbutton"),"SettingsMenuLogin",_ref.getField(false, "_settingsmenulogin")};
}
}