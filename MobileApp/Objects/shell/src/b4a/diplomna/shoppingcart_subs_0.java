...
try {
		Debug.PushSubsStack("AddItemToBasket (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,104);
...
try {
		Debug.PushSubsStack("AddQtty_Click (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,226);
...
try {
		Debug.PushSubsStack("AddSupplier (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("AsView (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,100);
...
try {
		Debug.PushSubsStack("BuildCart (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,149);
...
try {
		Debug.PushSubsStack("BuildCartUI (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("CalculateSum (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("ClearCart (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,343);
...
try {
		Debug.PushSubsStack("DelQtty_Click (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,235);
...
try {
		Debug.PushSubsStack("FinishOrder_Click (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,296);
...
try {
		Debug.PushSubsStack("GenerateRandomString (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,331);
...
try {
		Debug.PushSubsStack("GetGoodPrice (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("GetItemFromDB (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("Initialize (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("RefreshOverall (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("RemoveItemFromBasket (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,143);
...
try {
		Debug.PushSubsStack("RemoveItemFromBasket_Click (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,249);
...
try {
		Debug.PushSubsStack("SelectItemFromBasket_Click (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,281);
...
Debug.ShouldStop(268435456);
shoppingcart.__c.runVoidMethod ("LogImpl","45111812",RemoteObject.concat(RemoteObject.createImmutable("Clicked "),_pnl.runMethod(false,"getTag")),0);
...
try {
		Debug.PushSubsStack("TestWithFakes (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,256);
...
try {
		Debug.PushSubsStack("ViewSelectedItemInfo (shoppingcart) ","shoppingcart",6,__ref.getField(false, "ba"),__ref,288);
