...
try {
		Debug.PushSubsStack("AddItemToBasket (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("AddQtty_Click (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("AddSupplier (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("AsView (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("BuildCart (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,138);
...
try {
		Debug.PushSubsStack("BuildCartUI (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("CalculateSum (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("DelQtty_Click (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,221);
...
try {
		Debug.PushSubsStack("GetGoodPrice (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("GetItemFromDB (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,113);
...
__ref.setField ("_currentsupplier",parent._jsonserializations.runMethod(false,"_serializesupplier",__ref.getField(false, "ba"),(Object)(parent._main._http.getField(true,"_output"))));
 BA.debugLineNum = 124;BA.debugLine="Log(CurrentSupplier)";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","414286859",BA.ObjectToString(__ref.getField(false,"_currentsupplier")),0);
...
try {
		Debug.PushSubsStack("Initialize (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("RefreshOverall (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("RemoveItemFromBasket (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("RemoveItemFromBasket_Click (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,235);
...
try {
		Debug.PushSubsStack("SelectItemFromBasket_Click (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,266);
...
Debug.ShouldStop(8192);
shoppingcart.__c.runVoidMethod ("LogImpl","42162692",RemoteObject.concat(RemoteObject.createImmutable("Clicked "),_pnl.runMethod(false,"getTag")),0);
...
try {
		Debug.PushSubsStack("TestWithFakes (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,242);
...
try {
		Debug.PushSubsStack("ViewSelectedItemInfo (shoppingcart) ","shoppingcart",2,__ref.getField(false, "ba"),__ref,273);
