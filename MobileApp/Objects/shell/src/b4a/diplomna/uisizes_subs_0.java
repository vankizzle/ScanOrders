...
try {
		Debug.PushSubsStack("Initialize (uisizes) ","uisizes",3,_ba,uisizes.mostCurrent,24);
...
uisizes._settingsspinnerswidth = uisizes.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 26)),_ba);
 BA.debugLineNum = 42;BA.debugLine="SettingsSpinnersHeight = 5%y";
Debug.ShouldStop(512);
uisizes._settingsspinnersheight = uisizes.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),_ba);
 };
