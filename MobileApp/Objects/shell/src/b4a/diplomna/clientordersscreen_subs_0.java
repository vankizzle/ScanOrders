...
try {
		Debug.PushSubsStack("AsView (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("BuildUI (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("HideSettings (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,39);
...
try {
		Debug.PushSubsStack("Initialize (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("Settings_Click (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("test_Click (clientordersscreen) ","clientordersscreen",13,__ref.getField(false, "ba"),__ref,34);
