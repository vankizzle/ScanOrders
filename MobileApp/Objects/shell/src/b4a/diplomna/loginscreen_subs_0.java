...
Debug.ShouldStop(262144);
loginscreen.__c.runVoidMethod ("LogImpl","1851970",RemoteObject.createImmutable("login failed"),0);
 }else {
 BA.debugLineNum = 149;BA.debugLine="Log(\"login success\")";
Debug.ShouldStop(1048576);
loginscreen.__c.runVoidMethod ("LogImpl","1851972",RemoteObject.createImmutable("login success"),0);
 BA.debugLineNum = 150;BA.debugLine="Log(Job.GetString)";
Debug.ShouldStop(2097152);
loginscreen.__c.runVoidMethod ("LogImpl","1851973",_job.runClassMethod (b4a.diplomna.httpjob.class, "_getstring"),0);
 };
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","1786442",RemoteObject.createImmutable("LOGIN FAILED"),0);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","1786447",RemoteObject.concat(RemoteObject.createImmutable("Login Output:"),parent._main._http.getField(true,"_output")),0);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","1786451",RemoteObject.createImmutable("error"),0);
 if (true) break;
if (true) break;
