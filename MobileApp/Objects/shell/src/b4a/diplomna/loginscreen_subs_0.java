...
try {
		Debug.PushSubsStack("AsView (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("BuildUI (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("HideSettings (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,100);
...
try {
		Debug.PushSubsStack("Initialize (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("JobDone (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,139);
...
if (RemoteObject.solveBoolean("=",_job.getField(true,"_success"),loginscreen.__c.getField(true,"False"))) { 
 BA.debugLineNum = 141;BA.debugLine="Log(\"login failed\")";
Debug.ShouldStop(4096);
loginscreen.__c.runVoidMethod ("LogImpl","44915202",RemoteObject.createImmutable("login failed"),0);
 }else {
 BA.debugLineNum = 143;BA.debugLine="Log(\"login success\")";
Debug.ShouldStop(16384);
loginscreen.__c.runVoidMethod ("LogImpl","44915204",RemoteObject.createImmutable("login success"),0);
 BA.debugLineNum = 144;BA.debugLine="Log(Job.GetString)";
Debug.ShouldStop(32768);
loginscreen.__c.runVoidMethod ("LogImpl","44915205",_job.runClassMethod (b4a.diplomna.httpjob.class, "_getstring"),0);
 };
...
try {
		Debug.PushSubsStack("Login_Click (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,111);
...
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","44849673",RemoteObject.createImmutable("LOGIN FAILED"),0);
 if (true) break;

case 11:
//C
this.state = 12;
 BA.debugLineNum = 122;BA.debugLine="Log(\"Login Output:\" & Main.HTTP.Output)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","44849675",RemoteObject.concat(RemoteObject.createImmutable("Login Output:"),parent._main._http.getField(true,"_output")),0);
...
this.state = 17;
this.catchState = 16;
 BA.debugLineNum = 124;BA.debugLine="Main.LoggedCustomer = JSONSerializations.Seri";
Debug.ShouldStop(134217728);
...
this.state = 17;
this.catchState = 0;
 BA.debugLineNum = 126;BA.debugLine="Log(\"error\")";
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","44849679",RemoteObject.createImmutable("error"),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 BA.debugLineNum = 128;BA.debugLine="CallSub(Main,\"ShowMainScreen\")";
Debug.ShouldStop(-2147483648);
...
//C
this.state = 21;
 BA.debugLineNum = 132;BA.debugLine="ToastMessageShow(\"Enter Password!\",False)";
Debug.ShouldStop(8);
...
//C
this.state = 24;
 BA.debugLineNum = 135;BA.debugLine="ToastMessageShow(\"Enter Username!\",False)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("Register_Click (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,149);
if (RapidSub.canDelegate("register_click")) { return __ref.runUserSub(false, "loginscreen","register_click", __ref);}
 BA.debugLineNum = 149;BA.debugLine="Sub Register_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="CallSub(Main,\"HideAppSettingsScreen\")";
Debug.ShouldStop(2097152);
loginscreen.__c.runMethodAndSync(false,"CallSubNew",__ref.getField(false, "ba"),(Object)((loginscreen._main.getObject())),(Object)(RemoteObject.createImmutable("HideAppSettingsScreen")));
 BA.debugLineNum = 151;BA.debugLine="CallSub(Main,\"ShowRegisterScreen\")";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("Settings_Click (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("SettingsIsVisible (loginscreen) ","loginscreen",8,__ref.getField(false, "ba"),__ref,96);
