...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","51703946",RemoteObject.createImmutable("LOGIN FAILED"),0);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","51703951",RemoteObject.concat(RemoteObject.createImmutable("Login Output:"),parent._main._http.getField(true,"_output")),0);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","51703955",RemoteObject.createImmutable("error"),0);
 if (true) break;
if (true) break;
