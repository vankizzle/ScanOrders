...
try {
		Debug.PushSubsStack("AsView (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("BuildUI (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("FillSettings (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("Initialize (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("SpinnersView (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,39);
...
try {
		Debug.PushSubsStack("SpnFntSize_ItemClick (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("SpnLng_ItemClick (appsettingsscreen) ","appsettingsscreen",6,__ref.getField(false, "ba"),__ref,50);
