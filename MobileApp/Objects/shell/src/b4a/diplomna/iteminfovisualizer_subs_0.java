...
try {
		Debug.PushSubsStack("AsView (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("BuildInfoUI (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,31);
...
__ref.getField(false,"_itemdescriptionlbl").runMethod(true,"setTextSize",BA.numberCast(float.class, 20));
...
Debug.ShouldStop(65536);
__ref.getField(false,"_itemisdicontinuedlbl").runMethod(true,"setText",BA.ObjectToCharSequence("-"));
 BA.debugLineNum = 50;BA.debugLine="ItemIsDicontinuedlbl.TextSize = 18";
Debug.ShouldStop(131072);
__ref.getField(false,"_itemisdicontinuedlbl").runMethod(true,"setTextSize",BA.numberCast(float.class, 18));
...
__ref.getField(false,"_itemplulbl").runMethod(true,"setText",BA.ObjectToCharSequence("PLU:"));
...
__ref.getField(false,"_itemsuppliernamelbl").runMethod(true,"setText",BA.ObjectToCharSequence("Supplier"));
 BA.debugLineNum = 60;BA.debugLine="ItemSupplierNamelbl.TextSize = 16";
Debug.ShouldStop(134217728);
__ref.getField(false,"_itemsuppliernamelbl").runMethod(true,"setTextSize",BA.numberCast(float.class, 16));
...
Debug.ShouldStop(8);
__ref.getField(false,"_descriptiontext").runMethod(true,"setGravity",iteminfovisualizer.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 69;BA.debugLine="DescriptionText.Enabled = False";
Debug.ShouldStop(16);
__ref.getField(false,"_descriptiontext").runMethod(true,"setEnabled",iteminfovisualizer.__c.getField(true,"False"));
...
Debug.ShouldStop(256);
__ref.getField(false,"_infoholder").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_itemnamelbl").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(iteminfovisualizer.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 40)),__ref.getField(false, "ba"))),(Object)(iteminfovisualizer.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
...
iteminfovisualizer._descriptiontext = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");__ref.setField("_descriptiontext",iteminfovisualizer._descriptiontext);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _clearinfo(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("ClearInfo (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,101);
if (RapidSub.canDelegate("clearinfo")) { return __ref.runUserSub(false, "iteminfovisualizer","clearinfo", __ref);}
...
Debug.ShouldStop(64);
__ref.getField(false,"_descriptiontext").runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
...
try {
		Debug.PushSubsStack("Initialize (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("SetCurrentInfo (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,85);
...
Debug.ShouldStop(16777216);
__ref.getField(false,"_itemisdicontinuedlbl").runMethod(true,"setTextColor",iteminfovisualizer.__c.getField(false,"Colors").getField(true,"Red"));
 }else 
{ BA.debugLineNum = 90;BA.debugLine="Else if  g.Is_Discontinued = 0 Then";
Debug.ShouldStop(33554432);
...
Debug.ShouldStop(134217728);
__ref.getField(false,"_itemisdicontinuedlbl").runMethod(true,"setTextColor",iteminfovisualizer.__c.getField(false,"Colors").getField(true,"Green"));
 }}
;
...
Debug.ShouldStop(1);
__ref.getField(false,"_itemsuppliernamelbl").runMethod(true,"setText",BA.ObjectToCharSequence(_s.getField(true,"SupplierName")));
 BA.debugLineNum = 98;BA.debugLine="DescriptionText.Text = g.Description";
Debug.ShouldStop(2);
__ref.getField(false,"_descriptiontext").runMethodAndSync(true,"setText",BA.ObjectToCharSequence(_g.getField(true,"Description")));
