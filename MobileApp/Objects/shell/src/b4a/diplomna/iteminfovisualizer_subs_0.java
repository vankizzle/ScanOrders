...
try {
		Debug.PushSubsStack("AsView (iteminfovisualizer) ","iteminfovisualizer",8,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("BuildInfoUI (iteminfovisualizer) ","iteminfovisualizer",8,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Initialize (iteminfovisualizer) ","iteminfovisualizer",8,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("SetCurrentInfo (iteminfovisualizer) ","iteminfovisualizer",8,__ref.getField(false, "ba"),__ref,84);
