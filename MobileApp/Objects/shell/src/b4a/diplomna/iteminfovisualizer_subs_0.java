...
try {
		Debug.PushSubsStack("AsView (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,80);
...
__ref.getField(false,"_itemsuppliernamelbl").runMethod(true,"setText",BA.ObjectToCharSequence("Supplier:"));
 BA.debugLineNum = 60;BA.debugLine="ItemSupplierNamelbl.TextSize = 18";
Debug.ShouldStop(134217728);
__ref.getField(false,"_itemsuppliernamelbl").runMethod(true,"setTextSize",BA.numberCast(float.class, 18));
...
__ref.getField(false,"_descriptioncontext").runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_descriptiontext").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_descriptioncontext").runMethod(false,"getPanel").runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_descriptioncontext").runMethod(false,"getPanel").runMethod(true,"getHeight")));
 BA.debugLineNum = 72;BA.debugLine="InfoHolder.AddView(ItemNamelbl,0,0,40%x,5%y)";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("SetCurrentInfo (iteminfovisualizer) ","iteminfovisualizer",15,__ref.getField(false, "ba"),__ref,84);
...
__ref.getField(false,"_itemplulbl").runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("PLU:"),_g.getField(true,"PLU"))));
 BA.debugLineNum = 94;BA.debugLine="ItemSupplierNamelbl.Text = \"Supplier:\" & s.Suppli";
