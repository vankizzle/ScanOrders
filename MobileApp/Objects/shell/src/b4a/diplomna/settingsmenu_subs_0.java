...
try {
		Debug.PushSubsStack("AppSettings_Click (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("AsView (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("BuildMenu (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,35);
...
__ref.getField(false,"_lblshoppingcart").runMethod(true,"setText",BA.ObjectToCharSequence("Cart"));
...
__ref.getField(false,"_pnlholder").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_lblappsettings").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(settingsmenu.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 20)),__ref.getField(false, "ba"))),(Object)(settingsmenu.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }else 
...
__ref.getField(false,"_pnlholder").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_lblmyorders").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(settingsmenu.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 20)),__ref.getField(false, "ba"))),(Object)(settingsmenu.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }else 
...
__ref.getField(false,"_pnlholder").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_lblshoppingcart").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(settingsmenu.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 20)),__ref.getField(false, "ba"))),(Object)(settingsmenu.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }else 
...
Debug.ShouldStop(1073741824);
__ref.getField(false,"_pnlholder").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_lblloginscreen").getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(settingsmenu.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 20)),__ref.getField(false, "ba"))),(Object)(settingsmenu.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),__ref.getField(false, "ba"))));
 }}}}
;
...
try {
		Debug.PushSubsStack("HideSettingsWindow (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("Initialize (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,11);
...
Debug.ShouldStop(67108864);
settingsmenu.__c.runVoidMethod ("LogImpl","11048592",BA.NumberToString(__ref.getField(true,"_flag")),0);
...
try {
		Debug.PushSubsStack("LoginScreen_Click (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("MyOrders_Click (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("ShoppingCart_Click (settingsmenu) ","settingsmenu",2,__ref.getField(false, "ba"),__ref,87);
