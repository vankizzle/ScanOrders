...
try {
		Debug.PushSubsStack("AppSettings_Click (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("AsView (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("BuildMenu (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("HideSettingsWindow (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("Initialize (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,11);
...
Debug.ShouldStop(67108864);
settingsmenu.__c.runVoidMethod ("LogImpl","410616848",BA.NumberToString(__ref.getField(true,"_flag")),0);
...
try {
		Debug.PushSubsStack("LoginScreen_Click (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("MyOrders_Click (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("ShoppingCart_Click (settingsmenu) ","settingsmenu",15,__ref.getField(false, "ba"),__ref,87);
