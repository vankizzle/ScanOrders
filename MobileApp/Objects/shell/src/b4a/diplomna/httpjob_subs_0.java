...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,239);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,197);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,202);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4a.diplomna.httpjob.class, "_escapelink",(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,167);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,177);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4a.diplomna.httpjob.class, "_escapelink",(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,254);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,265);
...
Debug.JustUpdateDeviceLine();
if (true) return httpjob.__c.runMethod(false,"LoadBitmapResize",(Object)(httpjob._httputils2service._tempfolder),(Object)(__ref.getField(true,"_taskid")),(Object)(_width),(Object)(_height),(Object)(_keepaspectratio));
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,261);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,271);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,234);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,215);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.diplomna.httpjob.class, "_getstring2",(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,74);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializeHead",(Object)(_link));
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,58);
if (RapidSub.canDelegate("patchbytes")) { return __ref.runUserSub(false, "httpjob","patchbytes", __ref, _link, httpjob._data);}
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializePatch2",(Object)(_link),(Object)(httpjob._data));
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.diplomna.httpjob.class, "_patchbytes",(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,36);
if (RapidSub.canDelegate("postbytes")) { return __ref.runUserSub(false, "httpjob","postbytes", __ref, _link, httpjob._data);}
Debug.locals.put("Link", _link);
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializePost2",(Object)(_link),(Object)(httpjob._data));
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,139);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","911730951",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.diplomna.httpjob.class, "_postbytes",(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,82);
...
RemoteObject _fd = RemoteObject.declareNull("b4a.diplomna.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (b4a.diplomna.httpjob.class, "_multipartstartsection",(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.diplomna.httpjob.class, "_postbytes",(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.diplomna.httpjob.class, "_postbytes",(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,47);
if (RapidSub.canDelegate("putbytes")) { return __ref.runUserSub(false, "httpjob","putbytes", __ref, _link, httpjob._data);}
Debug.locals.put("Link", _link);
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req").runVoidMethod ("InitializePut2",(Object)(_link),(Object)(httpjob._data));
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,42);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.diplomna.httpjob.class, "_putbytes",(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",22,__ref.getField(false, "ba"),__ref,208);
