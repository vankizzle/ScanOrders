...
_screenpnl.AddView((android.view.View)(_orderinfovisual._asview().getObject()),__c.PerXToCurrent((float) (5),ba),__c.PerYToCurrent((float) (10),ba),__c.PerXToCurrent((float) (90),ba),__c.PerYToCurrent((float) (24),ba));
...
_test.Initialize(ba,"test");
 //BA.debugLineNum = 25;BA.debugLine="test.Color = Colors.Red";
_test.setColor(__c.Colors.Red);
 //BA.debugLineNum = 26;BA.debugLine="test.Text = \"TEST\"";
_test.setText(BA.ObjectToCharSequence("TEST"));
 //BA.debugLineNum = 27;BA.debugLine="test.Visible = False";
_test.setVisible(__c.False);
 //BA.debugLineNum = 28;BA.debugLine="ScreenPnl.AddView(test,0%x,5%y,10%x,5%y)";
_screenpnl.AddView((android.view.View)(_test.getObject()),__c.PerXToCurrent((float) (0),ba),__c.PerYToCurrent((float) (5),ba),__c.PerXToCurrent((float) (10),ba),__c.PerYToCurrent((float) (5),ba));
