...
anywheresoftware.b4a.keywords.Common.LogImpl("0131079","storage permission error",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("0131086","camera permission error",0);
 if (true) break;
...
mostCurrent._appmainscreen._infoscreen._clearinfo();
...
anywheresoftware.b4a.keywords.Common.LogImpl("03932166","======= Response ========",0);
 //BA.debugLineNum = 179;BA.debugLine="Log(Response)";
anywheresoftware.b4a.keywords.Common.LogImpl("03932167",BA.ObjectToString(_response),0);
 //BA.debugLineNum = 180;BA.debugLine="Log(\"======= Error ===========\")";
anywheresoftware.b4a.keywords.Common.LogImpl("03932168","======= Error ===========",0);
 //BA.debugLineNum = 181;BA.debugLine="Log(Error)";
anywheresoftware.b4a.keywords.Common.LogImpl("03932169",BA.ObjectToString(_error),0);
 //BA.debugLineNum = 182;BA.debugLine="Log(\"======================\")";
anywheresoftware.b4a.keywords.Common.LogImpl("03932170","======================",0);
