...
_itemnamelbl.setText(BA.ObjectToCharSequence("TEST"));
...
_itemdescriptionlbl.setTextSize((float) (25));
...
_itemisdicontinuedlbl.setTextSize((float) (20));
...
_itemplulbl.setText(BA.ObjectToCharSequence("PLU:"+BA.NumberToString(555)));
...
_itemsuppliernamelbl.setText(BA.ObjectToCharSequence("Supplier:"+"BILLA"));
 //BA.debugLineNum = 60;BA.debugLine="ItemSupplierNamelbl.TextSize = 20";
_itemsuppliernamelbl.setTextSize((float) (20));
...
_descriptiontext.setGravity(__c.Gravity.CENTER);
...
_infoholder.AddView((android.view.View)(_itemnamelbl.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (40),ba),__c.PerYToCurrent((float) (6),ba));
...
_itemsuppliernamelbl.setText(BA.ObjectToCharSequence("Supplier:"+_s.SupplierName));
