...
RDebugUtils.currentLine=11075584;
 //BA.debugLineNum = 11075584;BA.debugLine="Public Sub Initialize (Name As String, TargetModul";
RDebugUtils.currentLine=11075585;
 //BA.debugLineNum = 11075585;BA.debugLine="JobName = Name";
__ref._jobname = _name;
RDebugUtils.currentLine=11075586;
 //BA.debugLineNum = 11075586;BA.debugLine="target = TargetModule";
...
RDebugUtils.currentLine=11010049;
 //BA.debugLineNum = 11010049;BA.debugLine="Public JobName As String";
_jobname = "";
RDebugUtils.currentLine=11010050;
 //BA.debugLineNum = 11010050;BA.debugLine="Public Success As Boolean";
_success = false;
RDebugUtils.currentLine=11010051;
 //BA.debugLineNum = 11010051;BA.debugLine="Public Username, Password As String";
_username = "";
_password = "";
RDebugUtils.currentLine=11010052;
 //BA.debugLineNum = 11010052;BA.debugLine="Public ErrorMessage As String";
_errormessage = "";
RDebugUtils.currentLine=11010053;
 //BA.debugLineNum = 11010053;BA.debugLine="Private target As Object";
_target = new Object();
RDebugUtils.currentLine=11010055;
 //BA.debugLineNum = 11010055;BA.debugLine="Private taskId As String";
_taskid = "";
RDebugUtils.currentLine=11010056;
 //BA.debugLineNum = 11010056;BA.debugLine="Private req As OkHttpRequest";
_req = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest();
RDebugUtils.currentLine=11010057;
 //BA.debugLineNum = 11010057;BA.debugLine="Public Response As OkHttpResponse";
_response = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse();
RDebugUtils.currentLine=11010062;
 //BA.debugLineNum = 11010062;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=11010063;
 //BA.debugLineNum = 11010063;BA.debugLine="Type MultipartFileData (Dir As String, FileName A";
;
...
RDebugUtils.currentLine=11993089;
 //BA.debugLineNum = 11993089;BA.debugLine="req.InitializeDelete(Link)";
__ref._req.InitializeDelete(_link);
RDebugUtils.currentLine=11993090;
 //BA.debugLineNum = 11993090;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
...
RDebugUtils.currentLine=12058625;
 //BA.debugLineNum = 12058625;BA.debugLine="req.InitializeDelete(escapeLink(Link, Parameters)";
...
RDebugUtils.currentLine=11796481;
 //BA.debugLineNum = 11796481;BA.debugLine="req.InitializeGet(Link)";
...
RDebugUtils.currentLine=11862017;
 //BA.debugLineNum = 11862017;BA.debugLine="req.InitializeGet(escapeLink(Link, Parameters))";
...
RDebugUtils.currentLine=11534337;
 //BA.debugLineNum = 11534337;BA.debugLine="req.InitializeHead(Link)";
...
RDebugUtils.currentLine=11468808;
 //BA.debugLineNum = 11468808;BA.debugLine="req.InitializePatch2(Link, Data)";
__ref._req.InitializePatch2(_link,_data);
RDebugUtils.currentLine=11468811;
 //BA.debugLineNum = 11468811;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_httputils2service.getObject()),"SubmitJob",this);
...
RDebugUtils.currentLine=11206657;
 //BA.debugLineNum = 11206657;BA.debugLine="req.InitializePost2(Link, Data)";
...
RDebugUtils.currentLine=11730949;
 //BA.debugLineNum = 11730949;BA.debugLine="Dim length As Int";
_length = 0;
RDebugUtils.currentLine=11730950;
 //BA.debugLineNum = 11730950;BA.debugLine="If Dir = File.DirAssets Then";
if ((_dir).equals(__c.File.getDirAssets())) { 
RDebugUtils.currentLine=11730951;
 //BA.debugLineNum = 11730951;BA.debugLine="Log(\"Cannot send files from the assets folder.\")";
__c.LogImpl("911730951","Cannot send files from the assets folder.",0);
RDebugUtils.currentLine=11730952;
 //BA.debugLineNum = 11730952;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=11730954;
 //BA.debugLineNum = 11730954;BA.debugLine="length = File.Size(Dir, FileName)";
_length = (int) (__c.File.Size(_dir,_filename));
RDebugUtils.currentLine=11730955;
 //BA.debugLineNum = 11730955;BA.debugLine="Dim In As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
RDebugUtils.currentLine=11730956;
 //BA.debugLineNum = 11730956;BA.debugLine="In = File.OpenInput(Dir, FileName)";
_in = __c.File.OpenInput(_dir,_filename);
RDebugUtils.currentLine=11730957;
 //BA.debugLineNum = 11730957;BA.debugLine="If length < 1000000 Then '1mb";
if (_length<1000000) { 
RDebugUtils.currentLine=11730960;
 //BA.debugLineNum = 11730960;BA.debugLine="Dim out As OutputStream";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
RDebugUtils.currentLine=11730961;
 //BA.debugLineNum = 11730961;BA.debugLine="out.InitializeToBytesArray(length)";
_out.InitializeToBytesArray(_length);
RDebugUtils.currentLine=11730962;
 //BA.debugLineNum = 11730962;BA.debugLine="File.Copy2(In, out)";
__c.File.Copy2((java.io.InputStream)(_in.getObject()),(java.io.OutputStream)(_out.getObject()));
RDebugUtils.currentLine=11730963;
 //BA.debugLineNum = 11730963;BA.debugLine="PostBytes(Link, out.ToBytesArray)";
__ref._postbytes(null,_link,_out.ToBytesArray());
 }else {
RDebugUtils.currentLine=11730965;
 //BA.debugLineNum = 11730965;BA.debugLine="req.InitializePost(Link, In, length)";
__ref._req.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
RDebugUtils.currentLine=11730966;
 //BA.debugLineNum = 11730966;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\",";
__c.CallSubDelayed2(ba,(Object)(_httputils2service.getObject()),"SubmitJob",this);
 };
RDebugUtils.currentLine=11730969;
 //BA.debugLineNum = 11730969;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=11337729;
 //BA.debugLineNum = 11337729;BA.debugLine="req.InitializePut2(Link, Data)";
