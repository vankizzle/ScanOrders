...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.diplomna.httpjob");
            if (htSubs == null) {
...
if (true) return __c.LoadBitmapResize(_httputils2service._tempfolder,_taskid,_width,_height,_keepaspectratio);
...
__c.LogImpl("911534343","Cannot send files from the assets folder.",0);
