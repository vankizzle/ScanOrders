...
RDebugUtils.currentLine=3145743;
 //BA.debugLineNum = 3145743;BA.debugLine="FinishOrderbtn.Initialize(\"FinishOrder\")";
...
RDebugUtils.currentLine=3211293;
 //BA.debugLineNum = 3211293;BA.debugLine="FinishOrderbtn.TextColor = AppColors.FadedBlack";
__ref._finishorderbtn.setTextColor(_appcolors._fadedblack);
RDebugUtils.currentLine=3211294;
 //BA.debugLineNum = 3211294;BA.debugLine="FinishOrderbtn.Color = AppColors.LightGray";
__ref._finishorderbtn.setColor(_appcolors._lightgray);
RDebugUtils.currentLine=3211295;
 //BA.debugLineNum = 3211295;BA.debugLine="FinishOrderbtn.TextSize = 12";
__ref._finishorderbtn.setTextSize((float) (12));
RDebugUtils.currentLine=3211296;
 //BA.debugLineNum = 3211296;BA.debugLine="FinishOrderbtn.Gravity = Gravity.CENTER_HORIZONTA";
...
RDebugUtils.currentLine=3211304;
 //BA.debugLineNum = 3211304;BA.debugLine="pblBase.AddView(FinishOrderbtn, 70%x , 0, 20%x ,";
...
RDebugUtils.currentLine=4259840;
 //BA.debugLineNum = 4259840;BA.debugLine="Public Sub FinishOrder_Click";
RDebugUtils.currentLine=4259841;
 //BA.debugLineNum = 4259841;BA.debugLine="If ScannedItems.Size > 0 Then";
if (__ref._scanneditems.getSize()>0) { 
RDebugUtils.currentLine=4259842;
 //BA.debugLineNum = 4259842;BA.debugLine="Dim neworder As Order";
_neworder = new b4a.diplomna.types._order();
RDebugUtils.currentLine=4259843;
 //BA.debugLineNum = 4259843;BA.debugLine="neworder.Initialize()";
_neworder.Initialize();
RDebugUtils.currentLine=4259844;
 //BA.debugLineNum = 4259844;BA.debugLine="For Each g As Good In ScannedItems.Values";
{
...
RDebugUtils.currentLine=4259845;
 //BA.debugLineNum = 4259845;BA.debugLine="neworder.OrderedGoods.Add(g)";
_neworder.OrderedGoods.Add((Object)(_g));
RDebugUtils.currentLine=4259846;
 //BA.debugLineNum = 4259846;BA.debugLine="neworder.OrderTotalPrice = neworder.OrderTotalP";
_neworder.OrderTotalPrice = _neworder.OrderTotalPrice+_g.Price;
 }
};
RDebugUtils.currentLine=4259848;
 //BA.debugLineNum = 4259848;BA.debugLine="neworder.CutomerID = Main.LoggedCustomer.ID";
_neworder.CutomerID = _main._loggedcustomer.ID;
RDebugUtils.currentLine=4259849;
 //BA.debugLineNum = 4259849;BA.debugLine="neworder.OrderStatus = \"Waiting\"";
_neworder.OrderStatus = "Waiting";
RDebugUtils.currentLine=4259850;
 //BA.debugLineNum = 4259850;BA.debugLine="neworder.OrderCode = \"#\" & GenerateRandomString(";
_neworder.OrderCode = "#"+__ref._generaterandomstring(null,(int) (10));
RDebugUtils.currentLine=4259851;
 //BA.debugLineNum = 4259851;BA.debugLine="Main.HTTP.SendOrder(neworder)";
_main._http._sendorder(null,_neworder);
 }else {
RDebugUtils.currentLine=4259853;
 //BA.debugLineNum = 4259853;BA.debugLine="ToastMessageShow(\"No items in cart\",False)";
...
RDebugUtils.currentLine=4325376;
 //BA.debugLineNum = 4325376;BA.debugLine="Sub GenerateRandomString(StrLength As Int) As Stri";
RDebugUtils.currentLine=4325377;
 //BA.debugLineNum = 4325377;BA.debugLine="Dim RndString As String";
_rndstring = "";
RDebugUtils.currentLine=4325378;
 //BA.debugLineNum = 4325378;BA.debugLine="Dim RndNumber As Int";
_rndnumber = 0;
RDebugUtils.currentLine=4325379;
 //BA.debugLineNum = 4325379;BA.debugLine="Do While RndString.Length < StrLength";
while (_rndstring.length()<_strlength) {
RDebugUtils.currentLine=4325380;
 //BA.debugLineNum = 4325380;BA.debugLine="RndNumber = Rnd(48,123) 'Yep, 123, because the l";
_rndnumber = __c.Rnd((int) (48),(int) (123));
RDebugUtils.currentLine=4325381;
 //BA.debugLineNum = 4325381;BA.debugLine="If (RndNumber >= 48 And RndNumber <= 57) Or (Rnd";
if ((_rndnumber>=48 && _rndnumber<=57) || (_rndnumber>=65 && _rndnumber<=90) || (_rndnumber>=97 && _rndnumber<=112)) { 
RDebugUtils.currentLine=4325382;
 //BA.debugLineNum = 4325382;BA.debugLine="RndString = RndString & Chr(RndNumber)";
_rndstring = _rndstring+BA.ObjectToString(__c.Chr(_rndnumber));
 };
 }
;
RDebugUtils.currentLine=4325385;
 //BA.debugLineNum = 4325385;BA.debugLine="Return RndString";
