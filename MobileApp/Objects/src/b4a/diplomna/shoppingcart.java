...
_finishorderbtn.setTextColor(_appcolors._fadedblack);
...
_pblbase.AddView((android.view.View)(_finishorderbtn.getObject()),(int) (__c.PerXToCurrent((float) (70),ba)+__c.DipToCurrent((int) (2))),(int) (0+__c.DipToCurrent((int) (2))),(int) (__c.PerXToCurrent((float) (20),ba)-__c.DipToCurrent((int) (4))),(int) (__c.PerYToCurrent((float) (5),ba)-__c.DipToCurrent((int) (4))));
...
_sumlbl.Initialize(ba,"");
 //BA.debugLineNum = 31;BA.debugLine="FinishOrderbtn.Initialize(\"\")";
_finishorderbtn.Initialize(ba,"");
...
__c.LogImpl("54063236","Clicked "+BA.ObjectToString(_pnl.getTag()),0);
