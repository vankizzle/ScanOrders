...
anywheresoftware.b4a.keywords.Common.LogImpl("311141121",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
RDebugUtils.currentLine=10747907;
 //BA.debugLineNum = 10747907;BA.debugLine="TempFolder = File.DirInternalCache";
_tempfolder = anywheresoftware.b4a.keywords.Common.File.getDirInternalCache();
RDebugUtils.currentLine=10747908;
 //BA.debugLineNum = 10747908;BA.debugLine="Try";
try {RDebugUtils.currentLine=10747909;
 //BA.debugLineNum = 10747909;BA.debugLine="File.WriteString(TempFolder, \"~test.test\", \"test";
anywheresoftware.b4a.keywords.Common.File.WriteString(_tempfolder,"~test.test","test");
RDebugUtils.currentLine=10747910;
 //BA.debugLineNum = 10747910;BA.debugLine="File.Delete(TempFolder, \"~test.test\")";
anywheresoftware.b4a.keywords.Common.File.Delete(_tempfolder,"~test.test");
 } 
       catch (Exception e6) {
			processBA.setLastException(e6);RDebugUtils.currentLine=10747912;
 //BA.debugLineNum = 10747912;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("310747912",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
RDebugUtils.currentLine=10747913;
 //BA.debugLineNum = 10747913;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("310747913","Switching to File.DirInternal",0);
RDebugUtils.currentLine=10747914;
 //BA.debugLineNum = 10747914;BA.debugLine="TempFolder = File.DirInternal";
_tempfolder = anywheresoftware.b4a.keywords.Common.File.getDirInternal();
 };
RDebugUtils.currentLine=10747919;
 //BA.debugLineNum = 10747919;BA.debugLine="hc.Initialize(\"hc\")";
_hc.Initialize("hc");
RDebugUtils.currentLine=10747920;
 //BA.debugLineNum = 10747920;BA.debugLine="TaskIdToJob.Initialize";
...
RDebugUtils.currentLine=10813441;
 //BA.debugLineNum = 10813441;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=10944513;
 //BA.debugLineNum = 10944513;BA.debugLine="If hc.IsInitialized = False Then Service_Create";
