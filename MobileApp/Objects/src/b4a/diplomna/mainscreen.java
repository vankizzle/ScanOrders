...
__c.LogImpl("08978433","Camera Exists- "+BA.ObjectToString(_success),0);
...
__c.LogImpl("09043969","Start- Checking Camera",0);
...
__c.LogImpl("09109507","End- Checking Camera",0);
...
__c.LogImpl("09175045","Camera:"+BA.ObjectToString(_cameraexists),0);
 };
